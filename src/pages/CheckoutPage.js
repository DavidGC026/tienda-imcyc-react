...
const CheckoutPage = () => {
  ...
  const iva = cartItems ? cartItems.reduce((acc, item) => {
    if (item.section === 'mercancia') {
      return acc + (parseFloat(item.price) * item.quantity * 0.16);
    }
    return acc;
  }, 0) : 0;
            ...
            <div className="info-card" style={{
              ...
              <div className="card-body">
                ...
                <ul className="list-unstyled mb-0">
                  <li style={{ color: theme.palette.text.secondary }}>Mercancía incluye IVA del 16%</li>
                  <li style={{ color: theme.palette.text.secondary }}>Libros, E-books y Webinars están exentos de IVA</li>
